...
extension FighterModel {
    static func getData() -> [FighterModel] {
        return [FighterModel(name: "Shavkat Rakhmonov", wins: 15, defeats: 0, draws: 0, urlString: "nyzvwROUn48", photo: "photo_shavkat_rakhmonov"),
                ...
                FighterModel(name: "Movsar Evloev", wins: 16, defeats: 0, draws: 0, urlString: "WC-EgPIjNZU", photo: "photo_movsar_evloev"),
